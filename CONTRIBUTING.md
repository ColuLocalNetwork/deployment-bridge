...
1. Fork the repo ( https://github.com/ColuLocalNetwork/deployment-bridge/fork ).
...
### Issues
Creating and discussing [Issues](https://github.com/poanetwork/deployment-bridge/issues) provides significant value to the project. If you find a bug you can report it in an Issue.     
